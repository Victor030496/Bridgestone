...
<html>
    <head>
        ...
        <title>Listado de Activos por Leasing</title>
        <meta charset="UTF-8">
  ...
  <h2>Activos por Leasing</h2>
    ...
    <thead>
      <tr>
        <th class="success">Numero de serie</th>
        <th class="success">Fecha de entrada del activo</th>
    ...
    <tbody id="listado">
       ...
       <a href="RegistrarActivoLeasing.jsp "><button type="button" class="btn btn-default" >Atras</button></a>                 
        </div>
