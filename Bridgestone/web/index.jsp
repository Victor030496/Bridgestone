<%-- 
    Document   : index
    Created on : 02/10/2017, 08:55:52 PM
    ...
    <body>
        ...
        <div class = "container-fluid">     
          <div id="links" style="height:125px;  margin-right: 10px; margin-left: 1px; display: inline-flex; align-items: center; justify-content: end; float:left;">    
             ...
             <div class="container-fluid" style="width: 1360px; height:580px; background-image: url(imagenes/prin2.jpg); background-repeat: no-repeat; background-size:cover;">
            <div class="wrapper">
