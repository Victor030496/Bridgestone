<%-- 
    Document   : Ayudas
    Created on : 12/06/2018, 05:48:57 PM
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <% Usuario user = (Usuario) request.getSession().getAttribute("user"); %>
    ...
    <%   if (user!=null){%>
       ...
       <div  id= "mainDiv" class="container-fluid" style="width: 1360px; height:990px; background-image: url(imagenes/prin22.jpg); background-repeat: no-repeat; background-size:cover; ba">
    ...
    <li role="presentation">
      <a role="menuitem" tabindex="-1" href="ListadoUsuarios.jsp">Usuarios Registrados</a>
            ...
            <div   id = "divVideos">
            &nbsp;&nbsp;&nbsp;   <h2>  Video de ayuda para el modulo de inventario</h2>
           <center>
            <embed src="vide1.mp4" width="980" height="650">
           </center>
        </div>
