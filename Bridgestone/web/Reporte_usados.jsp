<%-- 
    Document   : Reporte_usados
    Created on : 01/05/2018, 04:10:21 PM
...
<html>
    <head>
        ...
        <title>Area de reportes de uso </title>
        <meta charset="UTF-8">
...
<!----------------------------------------------------------------------------------->
                 ...
                 <div class="container-fluid" style="width: 1360px; height:530px; background-image: url(imagenes/prin2.jpg); background-repeat: no-repeat; background-size:cover;">
                    ...
                    <div class="container">
  <h2>Area de reporte de uso de los equipos</h2>
      <br>  <br>
  ...
  Controller.prototype={
	Controller: function(model,view){
		...
		this.view=view;
          ...
          Proxy.getPrestamosParaDevoluciones2(function(result){
      ...
      Proxy.getPersonasParaDevoluciones2(function(result){
        ...
        Proxy.getEquiposParaDevoluciones2(function(result){
	...
	tr.appendChild(td);
     ...
     //  td= document.createElement("td");
      // img= document.createElement("img");
       ...
       //img.title="Editar";
       //var num2 = model.comprobantes[i].numeroDeComprobante;esta ye estaba comentada
       //console.log(num2);esta ye estaba comentada
